...
$(EGLIBC_PORTS_SOURCE_B): 
	...
	if [ -d $(EGLIBC_PORTS_SOURCE_B) ]; then \
	   ...
	   rev2=`cat $(EGLIBC_PORTS_SOURCE)`; \
	   if test "$$rev1" != "$$rev2"; then \
	      echo $$rev1 > $(EGLIBC_PORTS_SOURCE); \
	      echo Touched $(EGLIBC_PORTS_SOURCE) because of changes; \
	   fi; \
	else \
	   rm $(EGLIBC_PORTS_SOURCE); \
	fi
